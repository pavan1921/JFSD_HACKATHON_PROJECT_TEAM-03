                    ...
                    <div class="bg-secondary h-100 p-5">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">Vijayawada</span>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">pavankalyan@gmail.com</span>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">+91 7893098245 </span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-white mb-0">pavan sai</p>
                            </div>
                            <div class="d-flex mb-2">
